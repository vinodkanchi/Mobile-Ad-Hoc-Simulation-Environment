function u_tx8  = ...
    f_SIM_burst_tx8(ts1,data1,data2,data3,data4,data5,data6,data7,data8,data9,data10,data11,data12,data13,data14,data15,data16,N_TX,ts_scale)
...
%% Compose burst
b = [zeros(size(ts1));zeros(size(ts1));zeros(size(ts1));zeros(size(ts1));zeros(size(ts1));...
    zeros(size(ts1));zeros(size(ts1));ts1;...
